...
public class MentorAI : MonoBehaviour
{
    [Header("Pathfinding")]
    ...
    public bool targetFollowEnabled = false;
    ...
    private static readonly int MentorIdle = Animator.StringToHash("Mentor_Idle");
    private static readonly int MentorRun = Animator.StringToHash("Mentor_Run");
    ...
    private void FixedUpdate()
    {
        ...
        if (!followEnabled)
        {
            ChangeAnimationState(MentorIdle);
    ...
    private void PathFollow()
    {
        ...
        if (_isOnPlatform)
        {
            ...
            {
                gameObject.layer = LayerMask.NameToLayer("MentorThroughPlatform");
            }
            else
            {
                gameObject.layer = LayerMask.NameToLayer("Mentor");
            }
        }
        else
        {
        ...
        {
            ChangeAnimationState(MentorRun);
    ...
    private void GoToPosition()
    {
        ...
        _seeker.StartPath((Vector3)startNode.position, target.position, OnPathComplete);
    }
